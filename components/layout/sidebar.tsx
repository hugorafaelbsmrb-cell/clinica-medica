...
/**
 * Conteúdo do menu lateral em drawer (telas pequenas): o trigger e o estado
 * aberto/fechado ficam por conta da barra inferior (BottomNav), que monta o
 * Sheet. Fecha sozinho ao navegar via onNavigate.
 */
