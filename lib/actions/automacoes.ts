...
export async function saveMensagensAutomation(
  ...
  const msgSchema = z.object({
    ...
    whatsapp2: z.string().max(2000).optional(),
    whatsapp3: z.string().max(2000).optional(),
  ...
  const parsed = msgSchema.safeParse({
    ...
    whatsapp: formData.get("autoWhatsappFollowUpMsg"),
    whatsapp2: formData.get("autoWhatsappFollowUp2Msg"),
    whatsapp3: formData.get("autoWhatsappFollowUp3Msg"),
  ...
  const fields = {
    ...
    autoWhatsappFollowUpEnabled: flag(formData, "autoWhatsappFollowUpEnabled"),
    autoWhatsappFollowUpMsg: data.whatsapp?.trim() || null,
    autoWhatsappFollowUp2Msg: data.whatsapp2?.trim() || null,
    autoWhatsappFollowUp3Msg: data.whatsapp3?.trim() || null,
