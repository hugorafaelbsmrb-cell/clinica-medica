    ...
    <main className="flex min-h-screen flex-col bg-background md:flex-row">
      ...
      <section className="relative flex h-72 shrink-0 flex-col justify-center overflow-hidden md:h-auto md:min-h-screen md:w-1/2">
        ...
        <div className="relative flex flex-col items-start gap-3 p-5 text-left text-white md:p-10">
          ...
          <ul className="flex flex-col gap-1.5 text-sm font-medium text-white/95 md:gap-2.5 md:text-lg">
            <li className="flex items-center gap-2">
              <CalendarDays className="h-5 w-5 shrink-0 md:h-6 md:w-6" />
              Agendamento online de consultas
            </li>
            <li className="flex items-center gap-2">
              <HeartPulse className="h-5 w-5 shrink-0 md:h-6 md:w-6" />
              Atendimento Home Care
            </li>
            <li className="flex items-center gap-2">
              <FileText className="h-5 w-5 shrink-0 md:h-6 md:w-6" />
            ...
            <li className="flex items-center gap-2">
              <DollarSign className="h-5 w-5 shrink-0 md:h-6 md:w-6" />
